                ...
                c => new
                    {
                        ...
                        ExtraDayPickUp = c.Int(nullable: false),
                        UserId = c.String(maxLength: 128),
                        PickUpConfirmID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PickUpConfirmations", t => t.PickUpConfirmID, cascadeDelete: true)
                .ForeignKey("dbo.PickUpDays", t => t.PickUpDayId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId)
                .Index(t => t.PickUpDayId)
                .Index(t => t.UserId)
                .Index(t => t.PickUpConfirmID);
